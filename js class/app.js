...
// синтактической надстрокйка над 
...
class Comment {
   ...
   ? но он не будет преисво как отделный метод конретного экземпляра
...
const firstComment = new Comment('First comment')
? c помошю оператора instanceof можна проверит при нодлежность 
? экземпляру 
